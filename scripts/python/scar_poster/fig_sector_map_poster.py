...
# LAND is deliberately OFF (was covering fill color, especially for
# Ross given the Ross Ice Shelf's large extent). Re-add at zorder=0.5
# (below fill's zorder=1) if you want it back as a backdrop:
# ax.add_feature(cfeature.LAND, color="#D3D1C7", zorder=0.5)
