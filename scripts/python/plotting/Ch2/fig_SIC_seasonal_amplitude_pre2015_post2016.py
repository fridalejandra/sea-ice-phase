...
"""
Seasonal SIC amplitude: pre vs post.
...
Metric:
  ...
  For each calendar year and gridcell:
    Amp(year) = max(SIC_pct) - min(SIC_pct)   [%-points]

  Then:
    Amp_pre  = mean Amp over 1980–2015
    Amp_post = mean Amp over 2016–2023
...
SUBFOLDER = "amplitude_pre2015_post2016"
...
def make_amplitude_figure():
    ...
    vmax_delta = min(vmax_delta, 60.0)
    ...
    ax_pre.set_title("(a) Seasonal amplitude, pre (1980–2015) [%]", fontsize=9, fontweight="bold")
    ...
    ax_post.set_title("(b) Seasonal amplitude, post (2016–2023) [%]", fontsize=9, fontweight="bold")
    ...
    fig_name = "Fig_SIC_seasonal_amplitude_pre1980-2015_post2016-2023.png"
